...
public class LastName {
	...
	public static void main(String[] args) {
		        ...
		        // Check if the text cursor is visible in the last name text field
		        if (lastNameInput.getAttribute("class").contains("caret")) {
		            System.out.println("The text cursor is visible in the last name text field.");
		        } else {
		            System.out.println("The text cursor is not visible in the last name text field.");
		        }
